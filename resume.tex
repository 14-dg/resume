...
Softwareentwickler mit ausgeprägter Python-Expertise und Fokus auf Architektur,
Automatisierung und datengetriebene Systeme.
Erfahrung in der Konzeption und Umsetzung robuster technischer Anwendungen
im industriellen Umfeld.
Arbeite analytische, eigenverantwortlich und mit hoher Leistungsorientierung.

\vspace{0.4cm}

%================================================
\section*{Fachliche Interessen}
%================================================

\begin{itemize}[leftmargin=*]
    \item Automatisierung technischer Prozesse und Simulations-Workflows
    \item KI- und Machine-Learning-Methoden in industriellen Systemen
    \item Architektur robuster, sicherheitskritischer Softwaresysteme
    \item Verbindung von datengetriebenen Modellen mit realen technischen Systemen
\end{itemize}
%================================================
...
%================================================
\section*{Technische Frühentwicklung}
%================================================

\textbf{LEGO Mindstorms}
\begin{itemize}[leftmargin=*]
    \item Einstieg in Robotik und Programmierung ab dem 9. Lebensjahr
    \item Mehrjährige Entwicklung und Programmierung eigener Robotersysteme
    \item Frühe Auseinandersetzung mit Sensorik, Logik und algorithmischem Denken
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    ...
    \item Mehrjährige Erfahrung als Mannschaftskapitän in leistungsorientierten Teams
